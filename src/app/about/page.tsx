      ...
      <div className="container mx-auto px-8 md:px-4 py-8 max-w-6xl">
        ...
        <div className="prose dark:prose-invert mb-8">
          <p className="mb-4">
            ...
            you run in your console, and some might be &lsquo;how to&rsquo;
            style pieces of things I did in native UIs and daisy-chained steps
            together to achieve a cool end.
          </p>
          <p className="mb-4">
            Effectively A-OK is an experimentaly playground. And it&apos;s being
